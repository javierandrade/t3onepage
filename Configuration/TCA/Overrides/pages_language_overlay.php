...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addTCAcolumns('pages_language_overlay', $newPageColumns);

$GLOBALS['TCA']['pages_language_overlay']['palettes']['t3onepage'] = array(
  'canNotCollapse' => 1,
